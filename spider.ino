/*   -----------------------------------------------------------------------------
  ...
  This robot is driven by a Ardunio Pro mini Board.
  ...
  - Before use,you must to adjust the robot,in order to make it more accurate.
    - Adjustment operation
       measure real sites and set to real_site[4][3], make and run
   ---------------------------------------------------------------------------*/
...
{
  if (cmd == 1){
  do_test();  //testing functions
  }
  if(cmd == 2){
  readSerial(); // serial communicate funcitons
  }
}
